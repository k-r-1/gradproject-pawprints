    ...
    import com.swuproject.pawprints.ui.NotificationActivity
    ...
    class MainActivity : AppCompatActivity() {
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            // 알람 아이콘 클릭 시 NotificationActivity로 이동
            val toolbar = findViewById<Toolbar>(R.id.toolbar)
            val iconAlarm = toolbar.findViewById<ImageView>(R.id.icon_alarm) // ID 수정 후
